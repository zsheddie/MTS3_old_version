...
import sys
sys.path.append('.')
sys.path.append('E:\\KIT\\Masterarbeit\\worl_dmodel\\MTS3_change\\MTS3_release-master\\MTS3_release-master')
...
from agent.worldModels.MTS3_3_level import MTS3_3_level
...
class Experiment():
    ...
    def _wandb_init(self):
        ...
        if self.model_cfg.wandb.log:
            ...
            wandb.login(key="258440f6229286ca5f319cdaff64a9f618aa5566", relogin=True)
    ...
    def _train_world_model(self, train_obs, train_act, train_targets, test_obs, test_act, test_targets):
        ...
        mts3_model = MTS3_3_level(input_shape=[train_obs.shape[-1]], action_dim=train_act.shape[-1], config=self.model_cfg)
