import sys
sys.path.append('.')
sys.path.append('E:\\KIT\Masterarbeit\\world_model\\MTS3_change\\MTS3_release-master\\MTS3_release-master')
...
from experiments.exp_prediction_mts3_3_level import Experiment
